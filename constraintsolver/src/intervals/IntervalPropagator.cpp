...
void IntervalPropagator::setGlobalRanges(std::shared_ptr<std::vector<VarPtr>> vars, std::shared_ptr<std::vector<std::shared_ptr<std::vector<double>>>> ranges,
...
bool IntervalPropagator::propagate(TermPtr term)
{
